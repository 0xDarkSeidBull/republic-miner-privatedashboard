  ...
  {:else if searchResult}
    ...
    <div class="miner-card">
      ...
      <div class="miner-stats">
        ...
        <div class="miner-stat"><div class="miner-stat-label">Est. Points</div><div class="miner-stat-value" style="background:linear-gradient(135deg,var(--accent),var(--accent3));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">{fmt(searchEstPoints)}</div></div>
      </div>
