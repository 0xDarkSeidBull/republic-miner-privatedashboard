<script>
  ...
  // 🔥 WORKING CONFIG - Copy paste exact
  ...
  async function connectKeplr() {
    ...
    try {
      ...
      // Remove old chain config to avoid conflicts
      try {
  ...
  async function payAndInfer() {
    ...
    try {
      ...
      // Create client with REST endpoint
      ...
      console.log("Amount in arai:", amountInArai);
